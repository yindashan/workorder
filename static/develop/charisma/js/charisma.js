$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','/static/charisma/css/bootstrap-'+theme_name+'.css');
	}
...
*/	
	...
	if($("#sincos").length)
	{
		...
		for (var i = 0; i < 14; i += 0.5) {
			var base = 1372060800;
			sin.push([(base + i*300)*1000, Math.sin(i)/i]);
			cos.push([(base + i*300)*1000, Math.cos(i)]);
		}
